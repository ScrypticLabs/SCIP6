   ...
   *result = SCIP_DIDNOTRUN;
      ...
      && (branchrule->maxdepth == -1 || branchrule->maxdepth >= SCIPtreeGetCurrentDepth(tree)) )
   {
      ...
      if( runbranchrule )
      {
         ...
         // printf("calling from SCIPbranchruleExecLPSol...\n");
   ...
   *result = SCIP_DIDNOTRUN;
      ...
      && (branchrule->maxdepth == -1 || branchrule->maxdepth >= SCIPtreeGetCurrentDepth(tree)) )
   {
      ...
      if( runbranchrule )
      {
         ...
         /* call external method */
         printf("calling from SCIPbranchruleExecExternSol...\n");
   ...
   )
{
   ...
   *result = SCIP_DIDNOTRUN;
   ...
   // modified by Abhi Gupta
   // try only highest priority branching rule
   SCIP_CALL( SCIPbranchruleExecLPSol(set->branchrules[0], set, stat, tree, sepastore, cutoffbound, allowaddcons, result) );

   // DO NOT DO THIS HENCE COMMENTED BY ABHI GUPTA
